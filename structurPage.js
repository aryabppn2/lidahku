...
'</select>'+
'<span onclick=connect_toAddNews() style=color:green; class=bar-menu>ngomong</span>'+
'<span onclick=connect_toMarketPage() style=color:blue; class=bar-menu>market</span>'+
